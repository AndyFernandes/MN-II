...
float f(float valor, int opc_formula) { 
	switch(opc_formula) {
		case 1:
			return sin(valor);
		case 2: // vou mudar aqui
			return pow(log(3*valor), 5);
		case 3:
			return tan(valor);
		default:
...
int main(){
	...
	//cout << "\n-------------------------------------------";
	//cout << "\n NEWTON CODES FECHADA TRAPEZIO COM " << particoes <<" PARTICOES\n";
	//cout << NewtonCodes_Fechada_Trapezio_Particao(M_PI/2, 2*M_PI, particoes, 2);

	cout << "\n-------------------------------------------";
	cout << "\n NEWTON CODES FECHADA TRAPEZIO COM TOLERANCIA" << tolerancia << " \n";
	cout << NewtonCodes_Fechada_Trapezio_Tolerancia(a, b, tolerancia, 2);

	//cout << "\n-------------------------------------------";
	//cout << "\n NEWTON CODES ABERTA TRAPEZIO COM " << particoes <<" PARTICOES\n";
	//cout << NewtonCodes_Aberta_Trapezio_Particao(M_PI/2, 2*M_PI, particoes, 2);

	/*cout << "\n-------------------------------------------";
	cout << "\n NEWTON CODES ABERTA TRAPEZIO COM TOLERANCIA" << tolerancia<< "\n";
	cout << NewtonCodes_Aberta_Trapezio_Tolerancia(M_PI/2, 2*M_PI, tolerancia, 2);

	////////////////////////////////////////////////////////////////////////////////

	cout << "\n-------------------------------------------";
	cout << "\n NEWTON CODES FECHADA GRAU 2 COM " << particoes <<" PARTICOES\n";
	cout << NewtonCodes_Fechada_Grau2_Particao(M_PI/2, 2*M_PI, particoes, 2);

	cout << "\n-------------------------------------------";
	cout << "\n NEWTON CODES FECHADA GRAU 2 COM TOLERANCIA" << tolerancia<< "\n";
	cout << NewtonCodes_Fechada_Grau2_Tolerancia(M_PI/2, 2*M_PI, tolerancia, 2);

	cout << "\n-------------------------------------------";
	cout << "\n NEWTON CODES ABERTA GRAU 2 COM " << particoes <<" PARTICOES\n";
	cout << NewtonCodes_Aberta_Grau2_Particao(M_PI/2, 2*M_PI, particoes, 2);

	cout << "\n-------------------------------------------";
	cout << "\n NEWTON CODES ABERTA GRAU 2 COM TOLERANCIA" << tolerancia<< "\n";
	cout << NewtonCodes_Aberta_Grau2_Tolerancia(M_PI/2, 2*M_PI, tolerancia, 2);

	////////////////////////////////////////////////////////////////////////////////

	cout << "\n-------------------------------------------";
	cout << "\n NEWTON CODES FECHADA GRAU 3 COM " << particoes <<" PARTICOES\n";
	cout << NewtonCodes_Fechada_Grau3_Particao(M_PI/2, 2*M_PI, particoes, 2);

	cout << "\n-------------------------------------------";
	cout << "\n NEWTON CODES FECHADA GRAU 3 COM TOLERANCIA" << tolerancia<< "\n";
	cout << NewtonCodes_Fechada_Grau3_Tolerancia(M_PI/2, 2*M_PI, tolerancia, 2);

	cout << "\n-------------------------------------------";
	cout << "\n NEWTON CODES ABERTA GRAU 3 COM " << particoes <<" PARTICOES\n";
	cout << NewtonCodes_Aberta_Grau3_Particao(M_PI/2, 2*M_PI, particoes, 2);

	cout << "\n-------------------------------------------";
	cout << "\n NEWTON CODES ABERTA GRAU 3 COM TOLERANCIA" << tolerancia<< "\n";
	cout << NewtonCodes_Aberta_Grau3_Tolerancia(M_PI/2, 2*M_PI, tolerancia, 2);

	////////////////////////////////////////////////////////////////////////////////

	cout << "\n-------------------------------------------";
	cout << "\n NEWTON CODES FECHADA GRAU 4 COM " << particoes <<" PARTICOES\n";
	cout << NewtonCodes_Fechada_Grau4_Particao(M_PI/2, 2*M_PI, particoes, 2);

	cout << "\n-------------------------------------------";
	cout << "\n NEWTON CODES FECHADA GRAU 4 COM TOLERANCIA" << tolerancia<< "\n";
	cout << NewtonCodes_Fechada_Grau4_Tolerancia(M_PI/2, 2*M_PI, tolerancia, 2);

	cout << "\n-------------------------------------------";
	cout << "\n NEWTON CODES ABERTA GRAU 4 COM " << particoes <<" PARTICOES\n";
	cout << NewtonCodes_Aberta_Grau4_Particao(M_PI/2, 2*M_PI, particoes, 2);

	cout << "\n-------------------------------------------";
	cout << "\n NEWTON CODES ABERTA GRAU 4 COM TOLERANCIA" << tolerancia<< "\n";
	cout << NewtonCodes_Aberta_Grau4_Tolerancia(M_PI/2, 2*M_PI, tolerancia, 2);*/
